...
insert into ineuron values(02,'fsda','non-active',100);
...
insert into students_ineuron values(101 , 'fsda','test@gmail.com','active',02)
...
alter table test add constraint test_prim primary key(id,email_id); # this is not multiple of priimery key
## this is the  combinations of primery key
