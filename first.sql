...
create table if not exists bank_deatils(
age int,
job varchar(30),
marital varchar(30),
...
insert into bank_deatils values(58,"management","married","tertiary","no",2143,"yes","no","unknown",5,"may",261,1,-1,0,"unknown","no")

insert into bank_deatils values
...
select count(*) from  bank_deatils

select * from bank_deatils 

select age , loan , job from bank_deatils 
...
select * from bank_deatils where age = 60

select * from bank_deatils where age = 60 and job = 'retired'

select * from bank_deatils where education = 'unknown' or marital = 'single'

select * from bank_deatils where (education = 'unknown' or marital = 'single') and balance < 500

select distinct job from bank_deatils 
...
select sum(balance) from bank_deatils;
select avg(balance) as average_bal from bank_deatils;
select * from bank_deatils where balance = (select min(balance) from bank_deatils);
select * from bank_deatils where balance = (select max(balance) from bank_deatils);

select * from bank_deatils where loan="yes";
select avg(balance) as average_bal_of_admin from bank_deatils where job="admin.";
select * from bank_deatils where job="unknown" and age<45;
